...
"C:\ProgramData\chocolatey\lib\7zip\7z.exe" a -tzip ahkmon.zip ./imgs ahkmon.exe dqxtrl.db sqlite3.dll version ahkmon_updater.exe dialogFinder.exe questFinder.exe mapQuestFinder.exe storyFinder.exe mailFinder.exe loginMessageFinder.exe voicemailFinder.exe glossary.csv
